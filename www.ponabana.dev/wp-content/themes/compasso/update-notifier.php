...
define( 'NOTIFIER_THEME_NAME', 'Compasso' ); // The theme name
define( 'NOTIFIER_THEME_FOLDER_NAME', 'compasso' ); // The theme folder name
define( 'NOTIFIER_XML_FILE', 'http://demo.gawibowo.com/compasso/notifier.xml' ); // The remote notifier XML file containing the latest version of the theme and changelog
...
function update_notifier_menu() {
	if (function_exists('simplexml_load_string')) { // Stop if simplexml_load_string funtion isn't available
		...
		$theme_data = wp_get_theme('compasso');
